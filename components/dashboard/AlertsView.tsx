                                ...
                                {isSelected && (
                                    <div className="px-8 pb-8 pt-4 bg-neutral-950/50 border-t border-neutral-900 animate-in fade-in slide-in-from-top-2 duration-300">
                                        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-neutral-400">
                                            ...
                                            <div className="space-y-4">
                                                <h4 className="text-[9px] font-black text-neutral-600 uppercase tracking-[0.3em] border-b border-neutral-800 pb-2">Actions</h4>
                                                <div className="grid grid-cols-1 gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex items-center justify-center gap-2 py-2.5 border border-purple-500/30 bg-purple-500/10 text-purple-400 rounded text-[10px] font-black uppercase tracking-widest hover:bg-purple-500/20 transition-all"
                                                    >
